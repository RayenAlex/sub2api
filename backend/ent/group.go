...
type Group struct {
	...
	// WeeklyTokenLimit holds the value of the "weekly_token_limit" field.
	WeeklyTokenLimit *int64 `json:"weekly_token_limit,omitempty"`
	// MonthlyTokenLimit holds the value of the "monthly_token_limit" field.
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldID, group.FieldDailyTokenLimit, group.FieldWeeklyTokenLimit, group.FieldMonthlyTokenLimit, group.FieldDefaultValidityDays, group.FieldFallbackGroupID, group.FieldFallbackGroupIDOnInvalidRequest, group.FieldSortOrder, group.FieldRpmLimit:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldDailyTokenLimit:
		...
		case group.FieldWeeklyTokenLimit:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field weekly_token_limit", values[i])
			} else if value.Valid {
				_m.WeeklyTokenLimit = new(int64)
				*_m.WeeklyTokenLimit = value.Int64
			}
		case group.FieldMonthlyTokenLimit:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field monthly_token_limit", values[i])
			} else if value.Valid {
				_m.MonthlyTokenLimit = new(int64)
				*_m.MonthlyTokenLimit = value.Int64
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	if v := _m.WeeklyTokenLimit; v != nil {
		builder.WriteString("weekly_token_limit=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	if v := _m.MonthlyTokenLimit; v != nil {
		builder.WriteString("monthly_token_limit=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
