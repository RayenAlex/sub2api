...
func init() {
	...
	// usersubscriptionDescDailyTokenUsage is the schema descriptor for daily_token_usage field.
	usersubscriptionDescDailyTokenUsage := usersubscriptionFields[11].Descriptor()
	// usersubscription.DefaultDailyTokenUsage holds the default value on creation for the daily_token_usage field.
	usersubscription.DefaultDailyTokenUsage = usersubscriptionDescDailyTokenUsage.Default.(int64)
	// usersubscriptionDescWeeklyTokenUsage is the schema descriptor for weekly_token_usage field.
	usersubscriptionDescWeeklyTokenUsage := usersubscriptionFields[12].Descriptor()
	// usersubscription.DefaultWeeklyTokenUsage holds the default value on creation for the weekly_token_usage field.
	usersubscription.DefaultWeeklyTokenUsage = usersubscriptionDescWeeklyTokenUsage.Default.(int64)
	// usersubscriptionDescMonthlyTokenUsage is the schema descriptor for monthly_token_usage field.
	usersubscriptionDescMonthlyTokenUsage := usersubscriptionFields[13].Descriptor()
	// usersubscription.DefaultMonthlyTokenUsage holds the default value on creation for the monthly_token_usage field.
	usersubscription.DefaultMonthlyTokenUsage = usersubscriptionDescMonthlyTokenUsage.Default.(int64)
