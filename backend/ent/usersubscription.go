...
type UserSubscription struct {
	...
	// DailyTokenUsage holds the value of the "daily_token_usage" field.
	DailyTokenUsage int64 `json:"daily_token_usage,omitempty"`
	// WeeklyTokenUsage holds the value of the "weekly_token_usage" field.
	WeeklyTokenUsage int64 `json:"weekly_token_usage,omitempty"`
	// MonthlyTokenUsage holds the value of the "monthly_token_usage" field.
...
func (*UserSubscription) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usersubscription.FieldID, usersubscription.FieldUserID, usersubscription.FieldGroupID, usersubscription.FieldDailyTokenUsage, usersubscription.FieldWeeklyTokenUsage, usersubscription.FieldMonthlyTokenUsage, usersubscription.FieldAssignedBy:
...
func (_m *UserSubscription) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usersubscription.FieldDailyTokenUsage:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field daily_token_usage", values[i])
			} else if value.Valid {
				_m.DailyTokenUsage = value.Int64
			}
		case usersubscription.FieldWeeklyTokenUsage:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field weekly_token_usage", values[i])
			} else if value.Valid {
				_m.WeeklyTokenUsage = value.Int64
			}
		case usersubscription.FieldMonthlyTokenUsage:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field monthly_token_usage", values[i])
			} else if value.Valid {
				_m.MonthlyTokenUsage = value.Int64
			}
...
func (_m *UserSubscription) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("daily_token_usage=")
	builder.WriteString(fmt.Sprintf("%v", _m.DailyTokenUsage))
	builder.WriteString(", ")
	builder.WriteString("weekly_token_usage=")
	builder.WriteString(fmt.Sprintf("%v", _m.WeeklyTokenUsage))
	builder.WriteString(", ")
	builder.WriteString("monthly_token_usage=")
	builder.WriteString(fmt.Sprintf("%v", _m.MonthlyTokenUsage))
	builder.WriteString(", ")
