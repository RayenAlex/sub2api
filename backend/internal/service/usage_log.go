...
type UsageLog struct {
	...
	// AppliedPeakMultiplier is the peak multiplier snapshot for token-billed usage; nil means not applicable or historical.
	...
	// CacheDiagnostic is an opt-in, non-reversible request-shape and prompt-profile
	// diagnostic for trusted OpenCode-compatible accounts. Nil is stored as SQL NULL.
