...
func (b *billingCacheWorkerStub) UpdateSubscriptionUsage(ctx context.Context, userID, groupID int64, cost float64, tokens int64) error {
	atomic.AddInt64(&b.subscriptionUpdates, 1)
	return nil
}
...
func TestBillingCacheServiceQueueHighLoad(t *testing.T) {
	...
	svc.QueueUpdateSubscriptionUsage(1, 2, 1.5, 0)
